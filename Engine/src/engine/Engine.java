...
public class Engine {
    ...
    public Engine(InputStream xmlFileContext, List<ReadSemulatorXml> allReadSem) {
        try {
            readSem = new ReadSemulatorXml(xmlFileContext);
        ...
        program = new Program(readSem,true,allReadSem);
        programDTO = new ProgramDTO(program);
    }
    ...
    public ReadSemulatorXml getReadSem() {
        return readSem;
    }
