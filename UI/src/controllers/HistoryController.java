...
//    @FXML private TableView<HistoryOldRow> historyTable;
//    @FXML private TableColumn<HistoryOldRow, String> colRunNumber, colY, colDegree, colCycles, colProgramName;
//
...
//        HistoryOldRow row = historyTable.getSelectionModel().getSelectedItem();
//        if (row == null) return;
//
//        try {
